      ...
      class="card">
                <div class="d-flex justify-content-between p-2 px-3">
                    <div class="d-flex flex-row align-items-center"> 
                      ...
                      :src="`http://localhost:3000/images/users/${post.User.avatar}`" class="rounded-circle imageprofil"
                      alt="Photo de profil de l'utilisateur qui poste">
                      <img class="rounded-circle imageprofil "
                      ...
                      />
                        ...
                        <div class="d-flex flex-column ml-2"> 
                          <span class="font-weight-bold" aria-label="nom prénom de l'utilisateur">{{ post.User.lastName }} {{ post.User.firstName }}</span> 
