  ...
  <div class="container">
    ...
    <form>
      ...
      <div class="form-outline mb-4">
        ...
        required
        minlength="8" />
        <span class="errorMsg" v-if="dataSignup.password !== dataSignup.passwordConfirmation" >
      ...
      <button @click="signup()"
      type="button" 
      class="btn btn-secondary btn-block mb-3">S'inscrire</button>
    </form>
  </div>  
...
export default {
  ...
  computed: {
  formValid () {
      if(this.dataSignup.lastName == "" || this.dataSignup.firstName =="" || this.dataSignup.email =="" || this.dataSignup.password =="" )
      return false;
      if (this.lastNameError =="" && this.firstNameError =="" && this.dataSignup.email =="" && this.dataSignup.password =="")
          return true;
          else return false;
